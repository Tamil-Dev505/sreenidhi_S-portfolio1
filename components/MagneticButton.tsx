...
export default function MagneticButton({
  ...
  return (
    <motion.button
      ...
      className={`relative overflow-hidden glass-panel px-5 py-3 sm:px-8 sm:py-4 rounded-full font-bold tracking-wider group hover:box-glow transition-all duration-300 ${className}`}
    >
