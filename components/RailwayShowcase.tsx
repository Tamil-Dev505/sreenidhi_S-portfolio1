...
export default function RailwayShowcase() {
  return (
    <section id="railway-showcase" className="py-16 sm:py-20 lg:py-24 relative perspective-1000">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-brand-purple via-brand-cyan to-brand-blue opacity-30 group-hover:opacity-100 transition-opacity duration-700 blur-[1px] animated-gradient-border" />

          {/* Main Card Content (flex-row-reverse for staggered right-side video layout on desktop) */}
          <div className="relative rounded-2xl sm:rounded-3xl bg-[#050505]/90 backdrop-blur-xl p-4 min-[380px]:p-5 sm:p-8 lg:p-12 h-full flex flex-col lg:flex-row-reverse gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-3xl">
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={i}
                  className="absolute rounded-full bg-brand-purple/15 blur-[1px]"
                  style={{
            ...
            <div className="relative w-full lg:w-3/5 aspect-video rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 group/video shadow-2xl shadow-brand-purple/5">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-brand-blue/10 via-transparent to-brand-purple/10 pointer-events-none mix-blend-color-dodge" />
            </div>

            {/* Project Details Column (Renders on the left on desktop, bottom on mobile) */}
            <div className="w-full lg:w-2/5 flex flex-col justify-between h-full space-y-6 z-10">
              <div>
                ...
                <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-6">
                  A modern, full-stack railway reservation platform designed to simplify ticket bookings. Features rapid train search, real-time seat availability validation, user authentication, a structured checkout workflow, and a fully responsive interface.
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["React.js", "Node.js", "Express.js", "MongoDB", "Tailwind CSS"].map((t) => (
                    <span
                      key={t}
