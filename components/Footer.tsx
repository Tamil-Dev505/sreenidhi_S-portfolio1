...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-16 sm:pt-24 pb-10 border-t border-white/5 overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-16">
          ...
          <div className="text-center md:text-left">
            <Link href="/" className="text-2xl sm:text-3xl font-heading font-bold text-glow-blue break-words">
