    ...
    <section id="about" className="py-32 relative">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <motion.div
          ...
          className="glass-panel p-10 md:p-20 rounded-3xl relative overflow-hidden"
        >
          ...
          <h2 className="text-4xl md:text-6xl font-heading font-bold mb-10 text-glow-blue relative z-10">
            About Me
          </h2>

          <div className="flex flex-col md:flex-row gap-12 items-center relative z-10">
            <div className="flex-1 space-y-6 text-xl md:text-2xl leading-relaxed text-gray-300">
              <p>
