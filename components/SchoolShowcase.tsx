      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-gray-400 text-base sm:text-lg md:text-xl max-w-2xl mx-auto">
            A deep-dive walkthrough of my premium, full-stack deployed applications.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-brand-cyan via-brand-purple to-brand-blue opacity-30 group-hover:opacity-100 transition-opacity duration-700 blur-[1px] animated-gradient-border" />
          ...
          <div className="relative rounded-2xl sm:rounded-3xl bg-[#050505]/90 backdrop-blur-xl p-4 min-[380px]:p-5 sm:p-8 lg:p-12 h-full flex flex-col lg:flex-row-reverse gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-3xl">
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={i}
                  className="absolute rounded-full bg-brand-cyan/15 blur-[1px]"
                  style={{
            ...
            <div className="relative w-full lg:w-3/5 aspect-video rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 group/video shadow-2xl shadow-brand-cyan/5">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-brand-cyan/10 via-transparent to-brand-purple/10 pointer-events-none mix-blend-color-dodge" />
            </div>

            {/* Project Details Overlay / Column (Renders on the left on desktop, bottom on mobile) */}
            <div className="w-full lg:w-2/5 flex flex-col justify-between h-full space-y-6 z-10">
              <div>
                ...
                <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-6">
                  A full-stack school management platform designed for students, teachers, and administrators. The system provides secure authentication, role-based dashboards, attendance management, academic records, announcements, and efficient communication between teachers and students.
                </p>
