  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center z-10">
        <h1
          ref={titleRef}
          className="text-5xl md:text-8xl font-heading font-extrabold mb-4 uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-[#ededed] to-brand-blue"
        ...
        <h2
          ref={subtitleRef}
          className="text-xl md:text-3xl font-sans mb-6 text-brand-cyan text-glow-blue tracking-wide"
        >
